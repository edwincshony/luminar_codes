...
print(food_logs[1][5])   # calories
print("--------------")
print(food_logs[3][4])   # 3rd food item

# ----------------------------
# MOST CALORIE FOOD VLOGGER
# ----------------------------

max_cal = max(row[5] for row in food_logs)
max_cal_people = [row[1] for row in food_logs if row[5] == max_cal]
...
# People who ate dosa
dosa_people = [row[1] for row in food_logs if row[2] == "dosa"]

# People whose 2nd food is meals
meals_people = [row[1] for row in food_logs if row[3] == "meals"]
